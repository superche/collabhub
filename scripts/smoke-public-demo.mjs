...
try {
  ...
  console.log(JSON.stringify({ event: 'react_flow_public_demo_smoke_passed', landingUrl: `http://127.0.0.1:${port}/`, url: `http://127.0.0.1:${port}/demo.html`, documentId, canonicalVersion: 2, nodeCount: 3, landingVerified: true, socialImageVerified: true, starLink: true, activeRoomProtected: true, expiredRoomDeleted: true, originRejected: true, perIpConnectionLimit: true, reopenedVersion: 0 }))
} finally {
