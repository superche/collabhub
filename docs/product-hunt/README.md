...
| Status | Free and open source · technical preview |
...
Product Hunt accepts a YouTube link for the video rather than a direct MP4 upload. Upload the video master as an unlisted or public YouTube video, then paste that URL into the launch draft.
...
- [ ] Upload the video master to YouTube and add its URL to the draft.
